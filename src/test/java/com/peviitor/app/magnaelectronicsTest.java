...
class magnaelectronicsUtils extends utilsTest {
    @Override
...
public class magnaelectronicsTest {
    ...
    public void compare() {
        ...
        try {
            magnaelectronics.main(null);
            data = magnaelectronics.data.toString();
        } catch (Exception e) {
        ...
        try {
            results = new magnaelectronicsUtils().initiateTest(
                    data,
                    scraperApiEndpoint,
